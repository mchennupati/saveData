...
<html lang="en">
<head>
    <title>Code coverage report for src/Api/sources.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/Api</a> sources.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
     ...
     */
    getSource(sourceId, params = <span class="branch-1 cbranch-no" title="branch not covered" >{}) {</span>
        return new Promise((resolve, reject) =&gt; {
            try {
                const url = this.sourcesBuilder
                    .setAPIKey(this.apiKey)
...
&nbsp;
     ...
     */
    getReleasesForSource(sourceId, params = <span class="branch-1 cbranch-no" title="branch not covered" >{}) {</span>
        return new Promise((resolve, reject) =&gt; {
            try {
                const url = this.sourcesBuilder
                    .setAPIKey(this.apiKey)
