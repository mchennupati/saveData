...
<html lang="en">
<head>
    <title>Code coverage report for src/Api/releases.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/Api</a> releases.js
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>60/78</span>
      </div>
    </div>
  </div>
...
&nbsp;
                api.get('releases?' + url)
                    ...
                    .catch(<span class="fstat-no" title="function not covered" >(</span>err) =&gt; {
<span class="cstat-no" title="statement not covered" >                        reject(err.response.data);</span>
                    });
            } catch(e) {
...
&nbsp;
     ...
     * @returns {Promise} Resolves with all releases dates of economic data or errors out
     */
    getRelease(releaseId, params = <span class="branch-1 cbranch-no" title="branch not covered" >{}) {</span>
        return new Promise((resolve, reject) =&gt; {
            try {
                const url = this.releaseBuilder
                    .setAPIKey(this.apiKey)
...
&nbsp;
     ...
     * @returns {Promise} Resolves with all releases dates of economic data or errors out
     */
    getReleaseWithDates(releaseId, params = <span class="branch-1 cbranch-no" title="branch not covered" >{}) {</span>
        return new Promise((resolve, reject) =&gt; {
            try {
                const url = this.releaseBuilder
                    .setAPIKey(this.apiKey)
...
&nbsp;
     ...
     */
    getSeriesForRelease(releaseId, params = <span class="branch-1 cbranch-no" title="branch not covered" >{}) {</span>
        return new Promise((resolve, reject) =&gt; {
            try {
                const url = this.releaseBuilder
                    .setAPIKey(this.apiKey)
...
&nbsp;
     ...
     */
    getSourcesForRelease(releaseId, params = <span class="branch-1 cbranch-no" title="branch not covered" >{}) {</span>
        return new Promise((resolve, reject) =&gt; {
            try {
                const url = this.releaseBuilder
                    .setAPIKey(this.apiKey)
...
&nbsp;
     ...
     * @returns {Promise} Resolves with the sources for a release of economic data or errors out
     */
    getTagsForRelease(releaseId, params = <span class="branch-1 cbranch-no" title="branch not covered" >{}) {</span>
        return new Promise((resolve, reject) =&gt; {
            try {
                const url = this.releaseBuilder
                    .setAPIKey(this.apiKey)
...
&nbsp;
     ...
     */
    getRelatedTagsForRelease(releaseId, tagNames, params = <span class="branch-1 cbranch-no" title="branch not covered" >{}) {</span>
        return new Promise((resolve, reject) =&gt; {
            try {
                const url = this.releaseBuilder
                    .setAPIKey(this.apiKey)
...
&nbsp;
     ...
     */
    getTableTreesForRelease(releaseId, params = <span class="branch-1 cbranch-no" title="branch not covered" >{}) {</span>
        return new Promise((resolve, reject) =&gt; {
            try {
                const url = this.releaseBuilder
                    .setAPIKey(this.apiKey)
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Tue Sep 05 2017 22:06:19 GMT-0400 (EDT)
</div>
</div>
